...
export function createEmptyCase(existingCases: FuneralCase[]): FuneralCase {
  ...
  return {
    ...
    appointments: {
      cremation: { place: "Krematorium Solothurn", date: "", time: "", timeFrom: "", timeTo: "" },
      viewing: { place: "", date: "", time: "", timeFrom: "", timeTo: "" },
      farewell: { place: "", date: "", time: "", timeFrom: "", timeTo: "" },
      urnBurial: { place: "", date: "", time: "", timeFrom: "", timeTo: "" },
      graveType: "",
    },
    workReport: [],
